...
lineone.addEventListener("click", () => {
  document.querySelector(".photochange").style.backgroundImage =
    "url(https://additive.imgix.net/m/e/d/mediaservice/d/a/d/dada3a89513ed942d25aa33ce1d9cd6d?auto=format&fit=crop&h=800&q=90&w=800)";
...
linetwo.addEventListener("click", () => {
  document.querySelector(".photochange").style.backgroundImage =
    "url(https://additive.imgix.net/m/e/d/mediaservice/d/a/d/dada3a89513ed942d25aa33ce1d9cd6d?auto=format&fit=crop&h=800&q=90&w=800)";
  document.querySelector(".boxchange>h1").innerHTML =
    "HONEYMOON - RELAX AND SIT <br> BACK";
  document.querySelector(".details>p").innerHTML = "21.01.2023 - 01.05.2024";
...
linethree.addEventListener("click", () => {
  document.querySelector(".photochange").style.backgroundImage =
    "url(https://additive.imgix.net/m/e/d/mediaservice/a/a/7/aa7b9724af54a6e33c3325de53e6c2d3?auto=format&fit=crop&h=800&q=90&w=800)";
  document.querySelector(".boxchange>h1").innerHTML =
    "HONEYMOON - I'M YOUR  YIN AND <br> YOU'RE MY YANG";
...
linefour.addEventListener("click", () => {
  document.querySelector(".photochange").style.backgroundImage =
    "url(https://additive.imgix.net/m/e/d/mediaservice/2/1/c/21cd30f53d5df1012834764f5351e8f1?auto=format&crop=focalpoint&fit=crop&fp-x=0.63202527046192&fp-y=0.58998875140607&h=800&q=90&w=800)";
